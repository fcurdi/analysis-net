...
namespace MetadataGenerator
{
    ...
    public static class AttributesProvider
    {
        ...
        private static TypeAttributes EnumTypeAttributes(Model.Types.TypeDefinition self)
        {
            return TypeAttributes.Class |
                (Model.Types.VisibilityKind.Public.Equals(self.Visibility) ? TypeAttributes.Public : TypeAttributes.NotPublic) |
                TypeAttributes.Sealed;
        }

        private static TypeAttributes ClassTypeAttributes(Model.Types.TypeDefinition self)
        {
            return TypeAttributes.Class |
        ...
        private static TypeAttributes InterfaceTypeAttributes(Model.Types.TypeDefinition self)
        {
